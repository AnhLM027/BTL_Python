...
def train(
    model, device, train_loader, criterion, optimizer, epoch, train_loss, train_acc, mse
):
    model.train()
    curr_loss = 0
    t_pred = 0
    ...
    for batch_idx, (images, targets) in enumerate(train_loader):
        ...
        vae = mse(recons, images) # Mean Squared Error loss for VAE reconstruction
        loss = loss_m + vae  # Loss combining classification and VAE reconstruction
